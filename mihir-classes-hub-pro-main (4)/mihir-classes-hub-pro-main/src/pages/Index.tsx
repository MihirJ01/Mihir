...
const Index = () => {
  ...
  // Debug logging
  console.log("Auth state:", { isLoggedIn, isAdmin, isUser, user });

  if (!isLoggedIn) {
    console.log("Not logged in, showing login panel");
    return <LoginPanel />;
  }

  if (isUser && !isAdmin) {
    console.log("User logged in, showing user dashboard");
    return <UserDashboard />;
  }

  console.log("Admin logged in, showing admin panel");
