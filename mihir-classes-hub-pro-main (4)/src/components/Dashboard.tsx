        ...
        <Card className="rounded-2xl shadow-md border-0 bg-white/80 backdrop-blur">
          ...
          <CardContent className="p-3 sm:p-4 lg:p-6 pt-0">
            <div className="space-y-3 sm:space-y-4">
              <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-blue-50 rounded-lg border-l-4 border-blue-400 shadow-sm">
                <Users className="w-4 h-4 sm:w-5 sm:h-5 text-blue-600 flex-shrink-0" />
                <span className="text-xs sm:text-sm text-gray-800 font-medium">
                  {totalStudents} students enrolled in the system
                </span>
              </div>
              <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-green-50 rounded-lg border-l-4 border-green-400 shadow-sm">
                <Calendar className="w-4 h-4 sm:w-5 sm:h-5 text-green-600 flex-shrink-0" />
                <span className="text-xs sm:text-sm text-gray-800 font-medium">
                  Attendance tracking active for today
                </span>
              </div>
              <div className="flex items-center gap-2 sm:gap-3 p-2 sm:p-3 bg-orange-50 rounded-lg border-l-4 border-orange-400 shadow-sm">
